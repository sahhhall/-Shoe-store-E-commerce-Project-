...
adminRoute.get(
  "/createCategory",
  auth.isLogin,
  categoryController.loadaAddCategory
);
...
adminRoute.get(
  "/edit-category",
  auth.isLogin,
  categoryController.editCategorypageLoad
);
...
adminRoute.get(
  "/edit-product",
  auth.isLogin,
  productController.editProductpageLoad
);
...
adminRoute.get(
  "/product-detail",
  auth.isLogin,
  orderController.orderDetailedview
);
...
adminRoute.get(
  "/edit-coupon",
  auth.isLogin,
  couponController.editCouponPageLoad
);
...
adminRoute.post(
  "/add-banner",
  auth.isLogin,
  multerBanner.single("image"),
  bannerController.addBannner
);
adminRoute.get(
  "/edit-banner-page",
  auth.isLogin,
  bannerController.editBannerPageload
);
adminRoute.post(
  "/edit-banner-page",
  auth.isLogin,
  multerBanner.single("image"),
  bannerController.editBannerPost
);
adminRoute.post(
  "/list-unlist-banner",
  auth.isLogin,
